...
local function createControl(name, positionY, color, labelText, defaultValue, callback)
    ...
    IncreaseButton.Position = UDim2.new(0.8, -10, positionY, 0)
    IncreaseButton.Text = "+"
    ...
    DecreaseCorner.CornerRadius = UDim.new(0, 20)
    DecreaseCorner.Parent = DecreaseButton

    local IncreaseCorner = Instance.new("UICorner")
    IncreaseCorner.CornerRadius = UDim.new(0, 20)
...
createControl("Radius", 0.2, Color3.fromRGB(0, 0, 0), "Radius", config.radius, function(value)
    config.radius = value
    saveConfig()
end)

createControl("Height", 0.4, Color3.fromRGB(0, 0, 0), "Height", config.height, function(value)
    config.height = value
    saveConfig()
end)

createControl("RotationSpeed", 0.6, Color3.fromRGB(0, 0, 0), "Speed", config.rotationSpeed, function(value)
    config.rotationSpeed = value
    saveConfig()
end)

createControl("AttractionStrength", 0.8, Color3.fromRGB(0, 0, 0), "A Strength", config.attractionStrength, function(value)
...
MinimizeButton.Text = "-"
MinimizeButton.BackgroundColor3 = Color3.fromRGB(255, 153, 51)
